        ...
        <div className="relative w-full">
          {preview.active && (
            <div className="pointer-events-none absolute bottom-5 z-20 -translate-x-1/2" style={{ left: `${preview.position}%` }}>
              <div className="w-40 overflow-hidden rounded-md border border-white/25 bg-[#021723] shadow-xl">
    ...
    <section className="no-tracking relative w-full overflow-hidden bg-[#021723] text-[#f7f5f2]" aria-labelledby="about-title">
      ...
      <div className="relative mx-auto grid max-w-[1500px] grid-cols-1 gap-10 px-5 py-[clamp(4rem,4vw,9rem)] sm:px-10 lg:grid-cols-[2fr_3fr] lg:gap-14 lg:px-[4vw]">
        <div className="group relative mx-auto min-h-[22rem] w-full max-w-[25rem] self-center overflow-hidden rounded-[1.4rem] border-2 border-[#f7f5f2] bg-[#062033] sm:min-h-[30rem] lg:max-w-none lg:min-h-[clamp(22rem,38vw,35rem)]" aria-label="Prince Rakholiya creative editor">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_42%,rgba(6,39,71,0.88),transparent_0.5rem),radial-gradient(ellipse_at_50%_46%,#0b334c_0%,#041d2d_50%,#021723_100%)]">
            <img
              src={profileImage}
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#021723]/75 via-transparent to-[#021723]/10" aria-hidden="true" />
        ...
        <div className="max-w-[47rem] self-center">
          <h2 id="about-title" className="m-0 text-[clamp(2.5rem,5vw,5.5rem)] font-extrabold leading-[0.94] font-bricolage"><span className="text-[clamp(1.5rem,3.1vw,3.2rem)]">Hello, I&apos;m</span>{' '}<strong className="font-bold text-[#76b5d1]">Prince<br className="max-sm:hidden" /> Rakholiya</strong></h2>
      ...
      <div className="relative mx-auto grid max-w-[1500px] grid-cols-1 gap-12 border-t border-[#f7f5f2]/20 px-5 py-[clamp(3rem,3vw,6rem)] sm:px-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-[clamp(3rem,7vw,8rem)] lg:px-[4vw]">
        <div className="relative">
          ...
          <div className="mt-7 space-y-8">
            <div className="border-l-4 border-[#76b5d1] pl-5">
              <p className="m-0 font-poppins text-sm font-bold tracking-wide text-[#76b5d1]">2020 - 2021</p>
              <p className="m-0 mt-1 text-[15px] font-normal tracking-wider">SSC (10th) Hariom Vidhyalaya</p>
            </div>
            <div className="border-l-4 border-[#76b5d1] pl-5">
              <p className="m-0 font-poppins text-sm font-bold text-[#76b5d1] tracking-wide">2022 - 2023</p>
              <p className="m-0 mt-1 text-[15px] font-normal tracking-wider">HSC (12th) Nalanda Vidhyalaya</p>
            </div>
            <div className="border-l-4 border-[#76b5d1] pl-5">
              <p className="m-0 font-poppins text-sm font-bold text-[#76b5d1] tracking-wide">2023 - 2026</p>
          ...
          <div className="education-motion-art absolute bottom-0 left-0 right-0 hidden h-[5.5rem] overflow-hidden rounded-[1rem] border border-[#f7f5f2]/15 bg-[#f7f5f2]/[0.025] md:block" aria-hidden="true">
            <div className="absolute -left-5 -top-12 h-28 w-28 rounded-full border border-[#76b5d1]/35" />
            <div className="education-orbit absolute left-1/2 top-1/2 h-20 w-20 -translate-x-1/2 -translate-y-1/2 rounded-full border border-[#76b5d1]/55" />
            ...
            <div className="absolute left-1/2 top-1/2 h-2.5 w-2.5 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#76b5d1] shadow-[0_0_22px_#76b5d1]" />
            <span className="education-particle absolute left-[22%] top-[30%] h-2 w-2 rounded-full bg-[#f7f5f2]" />
            <span className="education-particle education-particle--delay absolute bottom-[26%] right-[20%] h-1.5 w-1.5 rounded-full bg-[#76b5d1]" />
            <div className="absolute left-5 right-5 h-px bg-gradient-to-r from-transparent via-[#76b5d1]/70 to-transparent" />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-7 space-y-8">
            <article className="border-b border-[#f7f5f2]/30 pb-4">
              ...
              <h3 className="m-0 mt-1 text-lg font-bold text-[#76b5d1]">Let's Automation</h3>
            ...
            <article className="pb-1">
              ...
              <h3 className="m-0 mt-1 text-lg font-bold text-[#76b5d1]">Digital Dukan</h3>
      ...
      <div className="relative mx-auto max-w-[1500px] border-t border-[#f7f5f2]/20 px-5 py-[clamp(3rem,3vw,6rem)] sm:px-10 lg:px-[4vw]">
        <div className="mb-8 flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
          <div>
            <h2 className="m-0 max-w-3xl text-[clamp(2rem,3.8vw,5rem)] font-extrabold leading-[0.9]">Expertise<span className="text-[#76b5d1]">.</span></h2>
          </div>
        </div>

        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="group flex items-center gap-4 border border-[#f7f5f2]/15 bg-[#f7f5f2]/[0.03] p-5 transition hover:border-[#76b5d1]/70 hover:bg-[#76b5d1]/10">
            <span className="flex h-3 w-3 shrink-0 rounded-full bg-[#76b5d1] shadow-[0_0_18px_#76b5d1]" />
        ...
        <div className="mt-20">
          <div className="mb-10 flex items-end justify-between gap-4">
            <h2 className="m-0 text-[clamp(2rem,3.7vw,3.8rem)] font-extrabold leading-none">Software Proficiency<span className="text-[#76b5d1]">.</span></h2>
          </div>
          <div className="grid grid-cols-1 gap-x-10 gap-y-8 md:grid-cols-2 lg:grid-cols-3">
            <div>
              <div className="mb-3 flex justify-between text-lg"><span className='tracking-wide'>Adobe After Effects</span><span className="font-poppins text-sm text-[#76b5d1]">80%</span></div>
              <div className="h-2 rounded-full bg-[#f7f5f2]/20"><div className="h-full w-[90%] rounded-full bg-[#76b5d1] shadow-[0_0_14px_rgba(6,39,71,0.55)]" /></div>
            </div>
            <div>
              <div className="mb-3 flex justify-between text-lg"><span className='tracking-wide'>Adobe Premiere Pro</span><span className="font-poppins text-sm text-[#76b5d1]">92%</span></div>
              <div className="h-2 rounded-full bg-[#f7f5f2]/20"><div className="h-full w-[92%] rounded-full bg-[#76b5d1] shadow-[0_0_14px_rgba(6,39,71,0.55)]" /></div>
            </div>
            <div>
              <div className="mb-3 flex justify-between text-lg"><span className='tracking-wide'>CapCut</span><span className="font-poppins text-sm text-[#76b5d1]">88%</span></div>
            ...
            {/* <div>
              <div className="mb-3 flex justify-between text-lg"><span className='tracking-wide'>Adobe Photoshop</span><span className="font-poppins text-sm text-[#76b5d1]">86%</span></div>
              <div className="h-2 rounded-full bg-[#f7f5f2]/20"><div className="h-full w-[86%] rounded-full bg-[#76b5d1] shadow-[0_0_14px_rgba(6,39,71,0.55)]" /></div>
            </div>
            <div>
              <div className="mb-3 flex justify-between text-lg"><span className='tracking-wide'>Illustrator</span><span className="font-poppins text-sm text-[#76b5d1]">84%</span></div>
              <div className="h-2 rounded-full bg-[#f7f5f2]/20"><div className="h-full w-[84%] rounded-full bg-[#76b5d1] shadow-[0_0_14px_rgba(6,39,71,0.55)]" /></div>
            </div> */}
            <div>
      ...
      <div className="relative mx-auto max-w-[1500px] border-t border-[#f7f5f2]/20 px-5 py-[clamp(3rem,3vw,6rem)] sm:px-10 lg:px-[4vw]">
        <div className="mb-7 flex items-end justify-between gap-5">
          <div>
            <h2 className="m-0 text-[clamp(2.3rem,3.8vw,5rem)] font-extrabold leading-[0.9]">Contents<span className="text-[#76b5d1]">.</span></h2>
          </div>
        </div>

        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
          <article className="group relative min-h-[15rem] overflow-hidden rounded-[1.25rem] border border-[#f7f5f2]/20 bg-gradient-to-br from-[#0d5b84] via-[#76b5d1] to-[#021723] p-7 transition-all duration-700 ease-out hover:-translate-y-2 hover:border-[#76b5d1] sm:p-10">
            <div className="absolute -right-10 -top-20 h-64 w-64 rounded-full border-[3rem] border-[#76b5d1]/20 blur-sm transition duration-700 group-hover:scale-125" aria-hidden="true" />
            <div className="relative flex h-full flex-col justify-between gap-12">
              ...
              <div>
                ...
                <p className="m-0 mt-4 max-w-sm text-sm leading-relaxed text-[#f7f5f2] tracking-wider">Fast, engaging edits built to stop the scroll and keep the story moving.</p>
              </div>
            </div>
          </article>

          <article className="group relative min-h-[15rem] overflow-hidden rounded-[1.25rem] border border-[#f7f5f2]/20 bg-[#f7f5f2] p-7 text-[#76b5d1] transition-all duration-700 ease-out hover:-translate-y-2 hover:border-[#76b5d1] sm:p-10">
            <div className="absolute -bottom-28 -right-16 h-72 w-72 rounded-full border-[3rem] border-[#76b5d1]/20 blur-sm transition duration-700 group-hover:scale-125" aria-hidden="true" />
            <div className="relative flex h-full flex-col justify-between gap-12">
              <span className="font-poppins text-sm font-medium tracking-wider text-[#0d5b84]">02 / CONTENT TYPE</span>
              <div>
                <h3 className="m-0 max-w-md text-[clamp(1.65rem,3.2vw,3rem)] font-extrabold leading-none">Motion Graphics</h3>
                <p className="m-0 mt-4 max-w-sm text-sm leading-relaxed text-[#76b5d1] tracking-wider">Bold movement, clean design, and visual energy that gives every frame a voice.</p>
              </div>
            </div>
          </article>
        </div>
      ...
      <div className="relative mx-auto max-w-[1500px] px-5 py-[clamp(3rem,3vw,6rem)] sm:px-10 lg:px-[7vw]">
        <div className="mb-7 flex flex-col items-center gap-4 text-center">
          <div>
            <h2 className="m-0 text-[clamp(2.3rem,3.8vw,5rem)] font-extrabold uppercase leading-[0.9]">Social Media <span className="text-[#76b5d1]">Reels</span></h2>
          </div>
        </div>
      ...
      <div className="relative mx-auto max-w-[1500px] border-t border-[#f7f5f2]/20 px-5 py-[clamp(3rem,3vw,6rem)] sm:px-10 lg:px-[7vw]">
        <div className="mb-7 flex flex-col items-center gap-4 text-center">
          <div>
            <h2 className="m-0 text-[clamp(2.3rem,3.8vw,5rem)] font-extrabold uppercase leading-[0.9]">Motion <span className="text-[#76b5d1]">Graphics</span></h2>
          </div>
        </div>
